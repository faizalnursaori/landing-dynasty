...
export const About = () => {
  return (
    <section id="about" className="py-16 bg-slate-100 text-gray-800 min-h-[60vh] ">
      <div className="max-w-5xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h2 className="text-2xl md:text-4xl font-extrabold tracking-wide mb-4">Tentang Kami</h2>
          <p className="text-justify md:text-lg leading-relaxed mb-6">
          ...
          <Link href="#" className="rounded-xl border border-yellow-500 px-4 py-2 bg-yellow-500">
            Load More
          </Link>
        </div>
