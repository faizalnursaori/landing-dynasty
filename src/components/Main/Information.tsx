    ...
    <section id="program" className="bg-gradient-to-b from-yellow-400 to-yellow-500 py-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-800 mb-4 intersect-once intersect:motion-preset-slide-up motion-delay-100">
            Program Kami
          </h2>
          <div className="w-24 h-1 bg-gray-800 mx-auto mb-6"></div>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto intersect-once intersect:motion-preset-slide-up motion-delay-150">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="aspect-square relative">
                  <Image
                    ...
                    width={300}
                    height={300}
                    className="w-full h-full object-cover transform transition duration-500 group-hover:scale-110 intersect-once intersect:motion-preset-slide-up motion-delay-160"
                  />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 text-white transform translate-y-full transition duration-300 group-hover:translate-y-0">
                    <h3 className="font-bold text-lg mb-1 intersect-once intersect:motion-preset-slide-up motion-delay-170">
                      {item.label}
                    </h3>
                    <p className="text-sm opacity-90 intersect-once intersect:motion-preset-slide-up motion-delay-180">
                      {item.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-6 p-6 bg-white rounded-2xl shadow-xl">
            <h3 className="text-xl md:text-3xl font-bold text-gray-800 mb-4 intersect-once intersect:motion-preset-slide-up motion-delay-190">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center space-x-3 intersect-once intersect:motion-preset-slide-up motion-delay-200"
                >
                  <ChevronRight className="w-5 h-5 text-yellow-500 intersect-once intersect:motion-preset-slide-up motion-delay-200" />
                  <p className="text-gray-700 intersect-once intersect:motion-preset-slide-up motion-delay-200">
                    {point}
                  </p>
                </div>
              ))}
